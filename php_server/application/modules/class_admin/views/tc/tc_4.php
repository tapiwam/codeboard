<div class="container"><?php $page = 4; ?>
    ...
    <fieldset>
        ...
        if ($num_tc > 0) {
            ...
            echo "<h4 class=\"alert alert-warning\">You specified that you did NOT need any test cases. If you do please go back to stage 1 and re-specify this or please continue...</h4>";
        }
        ?>
...
<?php for ($i = 1; $i <= $num_tc; $i++): ?>
    ...
    <?php if (isset($fileinfo)) : ?>
        ...
        <?php foreach ($fileinfo as $file): ?>
            <?php if ($file->multi_part == 1 && $file->stream_type == 'input' && $file->file_name != 'cin' && $file->meta == $i): ?>
