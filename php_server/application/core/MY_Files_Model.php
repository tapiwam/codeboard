...
class MY_Files_Model extends CI_Model {
	...
	function save_file($collection, $path, $filename, $meta=null){
		...
		if( $image != null || !empty($image) ){ return true; }
	}
	...
	function upload_file($collection)
	{
		...
		$config['allowed_types'] = 'gif|jpg|png|txt|doc|docx|xls|ppt|pptx|pdf|zip|rar|tar|gz|cpp|c|o|exe|run';
